        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-orange-100 mb-8 max-w-3xl mx-auto">
              Jadwal kegiatan dan acara Program Studi Teknik Perangkat Lunak
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mt-12">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center">
              <FiCalendar className="w-12 h-12 mx-auto mb-4 text-orange-200" />
              <div className="text-3xl font-bold mb-2">{totalAgenda}</div>
              <div className="text-orange-100">Total Agenda</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center">
              <FiClock className="w-12 h-12 mx-auto mb-4 text-red-200" />
              <div className="text-3xl font-bold mb-2">{upcomingEvents}</div>
              <div className="text-orange-100">Agenda Mendatang</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center">
              <FiAlertCircle className="w-12 h-12 mx-auto mb-4 text-pink-200" />
              <div className="text-3xl font-bold mb-2">{ongoingEvents}</div>
              <div className="text-orange-100">Sedang Berlangsung</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center">
              <FiUsers className="w-12 h-12 mx-auto mb-4 text-yellow-200" />
