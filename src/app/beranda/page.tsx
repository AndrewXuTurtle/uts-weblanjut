...
export default function Beranda() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                setStats({
                    dosen: Array.isArray(dosenData) ? dosenData.length : 0,
                    projects: Array.isArray(projectsData) ? projectsData.length : 0,
                    matakuliah: Array.isArray(matakuliahData) ? matakuliahData.length : 0
                });
            } catch (error) {
    ...
    return (
        <div className="pt-20 px-4 md:px-8 max-w-7xl mx-auto">
            {/* Hero Section */}
            <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-800 rounded-xl p-8 mb-10 text-white shadow-lg">
                <div className="text-center">
                    ...
                    <div className="flex flex-wrap gap-4 justify-center">
                        <Link href="/profil" className="bg-white text-blue-700 hover:bg-blue-50 px-6 py-3 rounded-lg font-semibold transition duration-300 shadow-md">
                            <FaRocket className="inline mr-2" />
                            Tentang Program
                        </Link>
                        <Link href="/mahasiswa" className="bg-transparent border-2 border-white hover:bg-white hover:text-blue-700 px-6 py-3 rounded-lg font-semibold transition duration-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-green-500 hover:shadow-lg transition duration-300">
                    <div className="flex items-center mb-4">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-purple-500 hover:shadow-lg transition duration-300">
                    <div className="flex items-center mb-4">
